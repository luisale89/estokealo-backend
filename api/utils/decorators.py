...
def json_required(schema: dict = None):
    def decorator(func):
    ...
    def wrapper(fn):
        ...
        def decorator(*args, **kwargs):
            ...
            if claims.get("role_access_token", None):
                ...
                if role is None:
                    raise APIException.from_response(
                        JSONResponse.permanently_deleted(
                            data={
                ...
                raise APIException.from_response(
                    JSONResponse.not_acceptable(
                        data={"jwt_claims": "'role_access_token' required"}
                    )
                )
    ...
    def wrapper(fn):
        ...
        def decorator(*args, **kwargs):
            ...
            if claims.get("user_access_token", False):
                ...
                raise APIException.from_response(
                    JSONResponse.not_acceptable(
                        data={"jwt_claims": "'user_access_token' required"}
                    )
                )
    ...
    def wrapper(fn):
        ...
        def decorator(*args, **kwargs):
            ...
            if claims.get("verification_token", False):
                ...
                raise APIException.from_response(
                    JSONResponse.not_acceptable(
                        data={"jwt_claims": "'verification_token' required"}
                    )
                )
    ...
    def wrapper(fn):
        ...
        def decorator(*args, **kwargs):
            ...
            if claims.get("verified_token", False):
                ...
                raise APIException.from_response(
                    JSONResponse.not_acceptable(
                        data={"jwt_claims": "'verified_token' required"}
                    )
                )
